...
преобразование данных проверяются отдельно. Закрепление версии оформления
за конкретной сохранённой картой — следующий этап: пока новые загрузки
приложения используют активный каталог.
