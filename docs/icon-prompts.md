...
## Дальше: остальные 520

Когда стиль утверждён на пилоте, промпты для оставшихся дописываются в этот же
файл партиями по школам магии. Школа определяет порядок партии, но не
монохромную палитру: цвет следует конкретному предмету или эффекту. Внутри
партии проверяются масштаб, направление света, плотность фактуры и различимость
силуэтов.

Порядок партий по убыванию объёма: Воплощение (89), Преобразование (86),
Вызов (79), Ограждение (47), Очарование (43), Некромантия (34), Прорицание (33),
Иллюзия (28), затем 93 боевых действия.
