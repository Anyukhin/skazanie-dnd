...
> Исторический документ ранней проверки продукта. Он описывает гипотезу о
> короткой сессии и не заменяет
> [`общую цель «Сказания»`](product-principles.md#назначение-и-цель): дать группе
> без человека-ведущего начать, пройти и завершить связную кампанию.
