...
export type TavernRoundCard = {
   ...
   *
   * Считает сервер (`tavernRoundUnanswerableReason`), и он же по этому ответу
   * решает, вернуть ли ставку вставшему из-за стола: своей арифметики чужой
   * кассы у доски здесь быть не должно, иначе панель обещала бы возврат там, где
