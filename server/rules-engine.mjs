...
export function resolveCommand(input, rawState, { diceService, context = {} } = {}) {
  ...
  switch (command.command_type) {
    ...
    case 'MakeAbilityCheck': {
      ...
      const checkRollOptions = { modifier, difficulty: safeInteger(command.difficulty, 10), purpose: `ability_check:${ability}`, actorId: command.actor_id, advantage: Boolean(command.advantage) || silveryFortune || Boolean(checkBoost), disadvantage: Boolean(command.disadvantage) || Boolean(checkPenalty) || armorStealthPenalty, visibility: command.visibility }
