 ...
 * числа пачек. Каталог здесь читается живым, как и профиль использования у
 * героя: в событие расхода уезжают уже посчитанные числа, поэтому replay
 * старого боя не зависит от будущей перебалансировки пачки.
 */
