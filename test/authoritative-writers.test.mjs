...
const KNOWN_WRITERS = Object.freeze({
  ...
  // Производные писатели переведены на исполнитель шагом 5. Остался один —
  // гибрид экономических часов: он в одном коммите несёт и пополнение лавки
  // (события Rules Engine), и событие часов, и разнести их значит потерять
  // атомарность. Разделение требует типизированной команды пополнения.
  'index.mjs': 1,
})
