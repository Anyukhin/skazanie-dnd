...
test('content integrity gate verifies hashes, references, counts and the complete asset registry', async () => {
  ...
  assert.deepEqual(report.integrity.item_catalog, { entries: 99, shop_entries: 12 })
  assert.equal(report.integrity.coverage.find((entry) => entry.id === 'equipment').count, 99)
